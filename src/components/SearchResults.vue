<template>
  <div class="container container-results">
        ...
        <div class="results-posts-wrapper">
          ...
          <div v-if="!query"> <h2>You need to enter a query</h2> </div>

            <div v-if="gettingResults"> <h2>Loading...</h2> </div>
...
.container-results {margin-top: 2em;}
...
.category-name span {margin-right: 15px;}
...
.result-post-link:hover {text-decoration: underline;}
